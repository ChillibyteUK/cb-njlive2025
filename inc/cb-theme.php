...
function widgets_init() {
    ...
    register_nav_menus(
        array(
            'primary_nav' => __( 'Primary Nav', 'cb-njlive2025' ),
        )
    );
...
function cb_theme_enqueue() {
    ...
    // phpcs:enable
    // enqueue splide.
    wp_enqueue_style( 'aos-style', 'https://unpkg.com/aos@2.3.1/dist/aos.css', array(), $the_theme->get( 'Version' ) );
    wp_enqueue_script( 'aos', 'https://unpkg.com/aos@2.3.1/dist/aos.js', array(), $the_theme->get( 'Version' ), true );
    wp_enqueue_style( 'swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css', array(), $the_theme->get( 'Version' ) );
    wp_enqueue_script( 'swiper', 'https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.js', array(), $the_theme->get( 'Version' ), true );
    wp_enqueue_script( 'gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', array(), $the_theme->get( 'Version' ), true );
    wp_enqueue_style( 'glightbox-style', get_stylesheet_directory_uri() . '/css/glightbox.min.css', array(), $the_theme->get( 'Version' ) );
    wp_enqueue_script( 'glightbox', get_stylesheet_directory_uri() . '/js/glightbox.min.js', array(), $the_theme->get( 'Version' ), true );
...
add_action(
	...
	function () {
    	...
    	if ( $post_id ) {
        	...
        	if ( 'page-templates/services.php' === $template ) {
