...
<head>
    ...
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Heavy_900.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Black_850.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Bold_700.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Semibold_600.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Regular_400.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <link rel="preload"
        href="<?= esc_url( get_stylesheet_directory_uri() . '/fonts/Apparat_Light_300.woff2' ); ?>"
        as="font" type="font/woff2" crossorigin="anonymous">
    <?php
...
<header id="wrapper-navbar" class="fixed-top p-0">
	<nav class="navbar navbar-expand-md">
		<div class="container gap-4">
			<div class="logo-container"><a href="/" class="logo navbar-brand" aria-label="NJ Live Homepage"></a></div>
